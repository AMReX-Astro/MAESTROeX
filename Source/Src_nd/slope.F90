          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   slim = merge(slim, ZERO, dpls*dmin.gt.ZERO)
                   sflag = sign(one,del)
                   slx(i,j,k,m)= sflag*min(slim,abs(del))
                enddo
          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   slx(i,j,k,m) = dflag*min(abs(ds),dlim)
          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   slim = merge(slim, ZERO, dpls*dmin.gt.ZERO)
                   sflag = sign(one,del)
                   sly(i,j,k,m)= sflag*min(slim,abs(del))
          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   sly(i,j,k,m) = dflag*min(abs(ds),dlim)
          ...
          do k = lo(3),hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   slim = merge(slim, ZERO, dpls*dmin.gt.ZERO)
                   sflag = sign(one,del)
                   slz(i,j,k,m)= sflag*min(slim,abs(del))
          ...
          do j = lo(2),hi(2)
             do i = lo(1),hi(1)
                do k = lo(3),hi(3)
                   ...
                   ds = two * two3rd * dcen -  &
                        sixth * (dzr + dzl)
                   slz(i,j,k,m) = dflag*min(abs(ds),dlim)
