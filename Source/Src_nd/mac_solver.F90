...
contains
  ...
  subroutine mac_bcoef_xface(lo, hi, &
       xface, x_lo, x_hi, &
       rhocc, r_lo, r_hi) bind(C, name="mac_bcoef_xface")
  ...
  end subroutine mac_bcoef_xface

#if (AMREX_SPACEDIM >= 2)
  subroutine mac_bcoef_yface(lo, hi, &
       yface, y_lo, y_hi, &
       rhocc, r_lo, r_hi) bind(C, name="mac_bcoef_yface")
  ...
  end subroutine mac_bcoef_yface

#if (AMREX_SPACEDIM == 3)
  subroutine mac_bcoef_zface(lo, hi, &
       zface, z_lo, z_hi, &
       rhocc, r_lo, r_hi) bind(C, name="mac_bcoef_zface")
  ...
  end subroutine mac_bcoef_zface
#endif
#endif
