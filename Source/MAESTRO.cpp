...
void
MAESTRO::timeStep (int lev, Real time, int iteration)
{
...
// advance a single level for a single time step, updates flux registers
void
MAESTRO::Advance (int lev, Real time, Real dt, int iteration, int ncycle)
{
...
Real
MAESTRO::EstTimeStep (int lev, bool local) const
{
