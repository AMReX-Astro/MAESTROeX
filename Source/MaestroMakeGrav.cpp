    ...
    if (!spherical) {
        if (do_planar_invsq_grav)  {
            ...
            for (auto r = 1; r < nr(0); ++r) {
                ...
                grav_cell(0,r) = -Gconst * m(0,r) / (r_cc_loc(0,r)*r_cc_loc(0,r));
            }
            ...
            for (auto n = 1; n <= finest_radial_level; ++n) {
                for (auto i = 1; i <= numdisjointchunks(n); ++i) {
                    ...
                    if (r_start_coord(n,i) == 0) {
                        ...
                        grav_cell(n,0) = -Gconst * m(n,0) / (r_cc_loc(n,0)*r_cc_loc(n,0));
                    } else {
                        ...
                        m(n,r) += term1 + term2;
                        grav_cell(n,r) = -Gconst * m(n,r) / (r_cc_loc(n,r)*r_cc_loc(n,r));
                    }
