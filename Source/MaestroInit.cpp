...
Maestro::Init ()
{
    ...
    if (restart_file == "") {
        ...
        if (plot_int > 0) {
            ...
            WritePlotFile(9999999,t_old,rho0_old,rhoh0_old,p0_old,gamma1bar_old,uold,sold);
        }
    }
    else {
    ...
    if (restart_file == "") {
        ...
        if (do_initial_projection) {
            ...
            if (plot_int > 0) {
                ...
                WritePlotFile(9999998,t_old,rho0_old,rhoh0_old,p0_old,gamma1bar_old,uold,sold);
            }
        }
        ...
        if (init_divu_iter > 0) {
            ...
            if (plot_int > 0) {
                ...
                WritePlotFile(9999997,t_old,rho0_old,rhoh0_old,p0_old,gamma1bar_old,uold,sold);
            }
        }
        ...
        if (plot_int > 0) {
            ...
            WritePlotFile(0,t_old,rho0_old,rhoh0_old,p0_old,gamma1bar_old,uold,sold);
        }
